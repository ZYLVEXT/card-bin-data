...
# imports `card_bin_data` early during plugin discovery.
test:
    COVERAGE_PROCESS_START=pyproject.toml uv run pytest --cov=src/card_bin_data --cov-report=term-missing --cov-fail-under=100 -n auto
